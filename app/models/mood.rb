class Mood < ActiveRecord::Base
  ...
  $sad_words = ["gloomy","work", "tragic", "depressive", "bleeding", "bummed out", "crummy", "dejected", "fed up", "glum", "grim", "low-spirited", "melancholy", "moody", "pessimistic", "sad", "unhappy", "death", "dead", "fear", "ruined", "lonely", "miserable", "anxious", "grief", "sorrow", "crying", "pathetic", "terrified", "scared","alone", "damnit", "sucks", "hate", "fuck", "shit", "mad", "pissed", "angry"]
